	...
	_In_ int       nCmdShow)
{
	...
	*/
	...
	Scene* _CLTutorial = new CLTutorial();
	_CLTutorial->SetJsonLoader(_JsonLoader, std::string("../Data/Scene"));
	_CLTutorial->SetSceneKind(eScene::Tutorial);
	DLLEngine::AddScene("Tutorial_SH", _CLTutorial);

	Scene* _CLTestSceneYH = new CLTestSceneYH();
	_CLTestSceneYH->SetJsonLoader(_JsonLoader, std::string("../Data/Scene"));
	_CLTestSceneYH->SetSceneKind(eScene::Generator);
	DLLEngine::AddScene("GenRoom", _CLTestSceneYH);

	SceneBase* _CLEndScene = new CLEndScene();
	DLLEngine::SetSceneName(_CLEndScene, "CLEndScene");
	DLLEngine::AddScene("CLEndScene", _CLEndScene);
	...
	DLLEngine::SelectScene("Tutorial_SH");
