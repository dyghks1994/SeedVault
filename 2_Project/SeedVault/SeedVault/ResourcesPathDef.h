...
namespace CL
{
	namespace ResourcePath
	{
		...
		const std::string ANIM_LAYER_PLAYER_RIFLE_BITED_DIE = "Player_Rifle_Bited_Die";
		const std::string ANIM_LAYER_PLAYER_RIFLE_BITED_DEAD = "Player_Rifle_Bited_Dead";

		// Bited_Die
		const std::string ANIM_PLAYER_RIFLE_BITED_DIE = "Rifle_Common_Death_By Clicker_mixamo.com.anim";
		const std::string ANIM_PLAYER_RIFLE_BITED_DEAD = "Rifle_Common_Dead_By Clicker_mixamo.com.anim";


		/// Override AnimLayer 이름
			const std::string ANIM_LAYER_PLAYER_RIFLE_AIM = "Player_Rifle_Aim";
			const std::string ANIM_LAYER_PLAYER_RIFLE_SHOOT = "Player_Rifle_Shoot";
			...
			const std::string ANIM_LAYER_PLAYER_RIFLE_HEAL = "Player_Rifle_Heal";
		...
		/// Animation 이름
			...
			// Shoot
			const std::string ANIM_PLAYER_RIFLE_SHOOT = "Rifle_Stand_Shoot_mixamo.com.anim";
			...
			// Heal
			const std::string ANIM_PLAYER_RIFLE_HEAL = "Rifle_Common_Heal_mixamo.com.anim";
		...
		#pragma region Player_Pistole
			...
			const std::string ANIM_LAYER_PLAYER_PISTOL_BITED_DIE = "Player_Pistol_Bited_Die";
			const std::string ANIM_LAYER_PLAYER_PISTOL_BITED_DEAD = "Player_Pistol_Bited_Dead";
			...
			const std::string ANIM_LAYER_PLAYER_PISTOL_ROUTING_ITEM = "Player_Pistol_RoutingItem";
			const std::string ANIM_LAYER_PLAYER_PISTOL_HEAL = "Player_Pistol_Heal";
			...
			const std::string ANIM_PLAYER_PISTOL_PITCH = "Pistol_Stand_Stop_mixamo.com.anim";

			// Reload
			const std::string ANIM_PLAYER_PISTOL_STAND_RELOAD = "Pistol_Stand_Reload_mixamo.com.anim";
			const std::string ANIM_PLAYER_PISTOL_CROUCH_RELOAD = "Pistol_Crouch_Reload_mixamo.com.anim";
			...
			// Heal
			const std::string ANIM_PLAYER_PISTOL_HEAL = "Pistol_Common_Heal_mixamo.com.anim";
			...
			// RoutingItem
			const std::string ANIM_PLAYER_PISTOL_ROUTING_ITEM = "Pistol_Common_Looting_mixamo.com.anim";

			// Bited_Die
			const std::string ANIM_PLAYER_PISTOL_BITED_DIE = "Pistol_Common_Death_By Clicker_mixamo.com.anim";
			const std::string ANIM_PLAYER_PISTOL_BITED_DEAD = "Pistol_Common_Dead_By Clicker_mixamo.com.anim";
		...
		#pragma region Zombie_Clicker
			//메쉬나 애니메이션 데이터는 이름만 있으면 되네(/Data/bin 폴더에 있음)
			/// Mesh
			const std::string MESH_Zombie_Clicker = "CZ_Idle__Injured Idle.bin";

			// None AnimLayer 이름
			const std::string ANIM_LAYER_Zombie_Clicker = "Zombie_Clicker";

			// State 이름
			const std::string ANIM_STATE_ZOMBIE_CLICKER_DIE = "Zombie_Clicker_Die";
			const std::string ANIM_STATE_ZOMBIE_CLICKER_DEAD = "Zombie_Clicker_Dead";
			const std::string ANIM_STATE_ZOMBIE_CLICKER_PATROL = "Zombie_Clicker_Patrol";
			const std::string ANIM_STATE_ZOMBIE_CLICKER_WAIT = "Zombie_Clicker_Wait";

			// Animation 이름
				// none (기본 베이스)
			const std::string ANIM_ZOMBIE_CLICKER_DIE = "CZ_HitDeath__Zombie Death_mixamo.com.anim";
			const std::string ANIM_ZOMBIE_CLICKER_DEAD = "CZ_HitDeath__Zombie Die_mixamo.com.anim";
			const std::string ANIM_ZOMBIE_CLICKER_PATROL = "CZ_Move__Injured Walk_mixamo.com.anim";
			const std::string ANIM_ZOMBIE_CLICKER_WAIT = "CZ_Idle__Injured Idle_mixamo.com.anim";
			const std::string ANIM_ZOMBIE_CLICKER_ATTACK_PLAYER = "CZ_Attack__Zombie Neck Bite_mixamo.com.anim";
			const std::string ANIM_ZOMBIE_CLICKER_AWAKEN_SOUNED = "CZ_Sound Find__Look Over Shoulder_mixamo.com.anim";
			const std::string ANIM_ZOMBIE_CLICKER_ASSASSINATED = "CZ_StealthDeath__Taken Hostage - Victim_mixamo.com.anim";

			#pragma endregion Zombie_Clicker


		#pragma region Item
			const std::string MESH_RIFLE = "Rifle.bin";
			const std::string MESH_PISTOL = "Pistol_Pistol92_s.bin";
			const std::string MESH_AMMO = "CartridgeBox_01.bin";				// 카트리지 박스
			const std::string MESH_HEAL_POTION = "BD_CM_GP_MedicineCase.bin";	// 힐 포션
			const std::string MESH_CARD_KEY = "CardKey.bin";		// 카드키(사무실 문여는 용도)
			const std::string MESH_FILE = "BG_GR_BD_File_03.bin";			// 파일(발전기 동작)
