...
public:
	...
	bool m_bCanRoutingItem;		// 아이템 루팅 가능 한가 판단
	bool m_bCanInteraction;		// 상호작용 상태인가 판단
	bool m_bIsHeal;				// 회복 상태인가 판단
	...
	bool m_bIsBited;			// 클리커에게 물어 뜯기는 사태
...
public:
	class CInteraction* m_InteractionObj;			// 상호작용 가능한 오브젝트

public:
	GameObject* m_RoutingItem;						// 루팅 가능한 아이템
