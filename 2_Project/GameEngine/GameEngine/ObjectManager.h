...
public:
	GameObject* FindContinualGameObect(const std::string& objectName);
	GameObject* FindContinualGameObect(const unsigned int& objectId);
...
public:
	...
	void RemoveToTagManager(const std::string& Tag, GameObject* object);
