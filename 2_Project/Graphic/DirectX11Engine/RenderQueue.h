...
public:
	...
	__declspec(noinline) void ProcessOpaqueQueue(Renderer* pRenderer);
	__declspec(noinline) void ProcessQueueByInstance(Renderer* pRenderer);
	__declspec(noinline) void ProcessTransparentQueue(Renderer* pRenderer);
	__declspec(noinline) void ProcessBillboardQueue(Renderer* pRenderer);
	__declspec(noinline) void ProcessDebugQueue(Renderer* pRenderer);
	__declspec(noinline) void ProcessOutLineQueue(Renderer* pRenderer, bool isQT);
