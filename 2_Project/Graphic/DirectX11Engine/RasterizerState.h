...
private:
	...
	static ID3D11BlendState* m_alphaEnableBlendingStateUICombine;
...
public:
	...
	static ID3D11BlendState* GetAlphaBlenderStateUICombine() { return m_alphaEnableBlendingStateUICombine; }
